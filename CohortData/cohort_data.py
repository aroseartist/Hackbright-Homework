...
def sort_by_cohort(filename):
    ...
    for line in the_file:
        ...
        student_name = individual[0] + " " + individual[1]
        if individual[4] == "TA":
            tas.append(student_name)
        else:
            #all_students.append(student_name)
            if individual[4] == "Winter 2015":
                winter_15.append(student_name)
            elif individual[4] == "Spring 2015":
                spring_15.append(student_name)
            elif individual[4] == "Summer 2015":
...
def students_by_house(filename):
    ...
    for line in the_file:
        ...
        if individual[4] == "TA":
            ...
            #all_students.append(student_name)
            if individual[2] == "Gryffindor":
                gryffindor.append(individual[1])
            elif individual[4] == "Hufflepuff":
                hufflepuff.append(individual[1])
            elif individual[4] == "Slytherin":
                slytherin.append(individual[1])
            elif individual[4] == "Dumbledore's Army":
                dumbledores_army.append(individual[1])
            elif individual[4] == "Order of the Phoenix":
                order_of_the_phoenix.append(individual[1])
            elif individual[4] == "Ravenclaw":
                ravenclaw.append(individual[1])
